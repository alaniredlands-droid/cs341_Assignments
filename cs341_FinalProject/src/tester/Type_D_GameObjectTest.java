...
class Type_D_GameObjectTest {

	private Type_D_GameObject gameObject;

	@BeforeEach
	public void setUp() {
		gameObject = new Type_D_GameObject(100, 100);
	}
	...
	public void testMoveDown() {
		...
		assertTrue(gameObject.getY() > 50, "Object should move down.");
	}
